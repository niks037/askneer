...
useEffect(() => {
  ...
  // ALL hooks above this line, checks below
  ...
  if (!session) return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #FFF9F5 0%, #FFF0E8 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24, fontFamily: "'Segoe UI', sans-serif" }}>
      ...
      <div style={{ background: "white", borderRadius: 20, padding: 32, maxWidth: 380, width: "100%", boxShadow: "0 8px 40px rgba(0,0,0,0.08)" }}>
        ...
        <button onClick={() => signIn("google")} style={{ width: "100%", padding: "14px 24px", background: "white", border: "2px solid #E8E8E8", borderRadius: 12, cursor: "pointer", fontSize: 15, fontWeight: 600, color: "#2D2D2D", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, transition: "all 0.2s" }}
    ...
    <div style={{ height: "100vh", background: "#FFF9F5", fontFamily: "'Segoe UI', sans-serif", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {messages.length === 0 ? (
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
          ...
          <p style={{ color: "#888", margin: "0 0 32px", fontSize: 15, textAlign: "center", maxWidth: 400 }}>Ask me anything about {profile.name}'s health, sleep, feeding, development, or behavior.</p>
        ...
        <>
          ...
          {/* Bottom input */}
          <div style={{ background: "white", borderTop: "1px solid #F0F0F0", padding: "12px 16px" }}>
